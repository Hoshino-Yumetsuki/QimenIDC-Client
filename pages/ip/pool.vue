            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="breadcrumb-main">
                        <h4 class="text-capitalize breadcrumb-title">IPV4 - 地址池列表</h4>
                                    ...
                                    <table class="table mb-0">
                                        <thead>
                                            <tr class="userDatatable-header">
                                                ...
                                                <th>
                                                    <span class="userDatatable-title">节点(绑定)</span>
                                                </th>
                                                <th>
                                                ...
                                                <th>
                                                    <span class="userDatatable-title">可用</span>
                                                </th>
                                                <th>
                                                    <span class="userDatatable-title">已用</span>
                                                </th>
                                                <th>
                                                    <span class="userDatatable-title">禁用</span>
                                                </th>
                ...
                if (res.data.code === 20000) {
                    ...
                    records.forEach(record => {
                        ...
                        const newRecord = {
                            id: record.id,
                            name: record.name || '未知',
                            gateway: record.gateway || '未知',
                            mask: record.mask || '未知',
                            dns1: record.dns1 || '未知',
                            dns2: record.dns2 || '未知',
                            available: record.available || 0,
                            used: record.used || 0,
                            disable: record.disable || 0,
                            nodeid: record.nodeid || 0,
                        };
