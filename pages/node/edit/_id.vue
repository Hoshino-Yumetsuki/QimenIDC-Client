                                ...
                                <div class="edit-profile__body">
                                    <form>
                                        <div class="form-group mb-25">
                                            ...
                                            <input type="text" class="form-control" id="id" placeholder="镇江A区">
                                            <li class="fa fa-exclamation-circle" style="color: rgb(255, 225, 0);"></li>
                                            <small class="text-danger">与同集群非同节点区别开</small>
                                        </div>
                                        <div class="form-group mb-25">
                                            <label for="name2">地区</label>
                                            <input type="text" class="form-control" id="name2" placeholder="镇江">
                                        </div>
                                        <div class="form-group mb-25">
                                        ...
                                        <div class="form-group mb-25">
                                            ...
                                            <input type="text" readonly class="form-control-plaintext" id="autoStorage" placeholder="Example">
                                        </div>
                                        <div class="form-group mb-25">
                                            <label for="csrfToken">csrfToken</label>
                                            <textarea type="text" readonly class="form-control-plaintext" id="csrfToken" placeholder="Position"/>
                                        </div>
                                        <div class="form-group mb-25">
                                            <label for="ticket">ticket</label>
                                            <textarea type="text" readonly class="form-control-plaintext" id="ticket" placeholder="Position"/>
                                        </div>
                                        <div class="button-group d-flex pt-25 justify-content-end">



                                            <button class="btn btn-primary btn-default btn-squared text-capitalize radius-md shadow2">修改
                                            </button>
